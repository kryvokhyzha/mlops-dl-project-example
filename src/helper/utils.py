...
from src.helper.logger import pylogger, rich_utils
...
def extras(cfg: DictConfig) -> None:
    """Apply optional utilities before starting the task.
...
def task_wrapper(task_func: Callable) -> Callable:
    """Control the failure behavior when executing the task function using this optional decorator.
